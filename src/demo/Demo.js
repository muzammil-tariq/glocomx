...
const latestList = [
  {
    imageUrl: 'course.png',
    title: 'Fundamentals for Real Estate NFT Trading ',
    price: '670',
    tag: 'Real Estate NFTs',
    lesson: '32 ',
    status: 'alert-warning text-warning',
  },
  {
    imageUrl: 'course.png',
    title: 'Automate Carbon Credit Verification',
    price: '760',
    tag: 'Crabon Credit NFTs',
    lesson: '14 ',
    status: 'alert-primary text-primary',
  },
  {
    imageUrl: 'course.png',
    title: 'Lumber on Smart Contract ',
    price: '370',
    tag: 'Lumber NFTs',
    lesson: '23 ',
  ...
  {
    imageUrl: 'course.png',
    title: 'Complete End-End Education on Smart Car NFTs ',
    price: '2400',
    tag: 'Smart Car NFTs',
    lesson: '32 ',
    status: 'alert-warning text-warning',
  ...
  {
    imageUrl: 'course.png',
    title: 'Complete End-End Education on Commercial Real Estate NFTs ',
    price: '40',
    tag: 'Commercial Real Estate NFTs',
    lesson: '24 ',
    status: 'alert-danger text-danger',
  },
];
...
const classesList = [
  ...
  {
    imageUrl: 'user-3.png',
    title: 'Lumber NFT Expert',
    num: '76 Course',
    bg: '#e5f4fb',
  },
  {
    imageUrl: 'user-5.png',
    title: 'Smart Car NFTs',
    num: '76 Course',
    bg: '#dcf4f8',
  },
  {
    imageUrl: 'user-6.png',
    title: 'Import and Export Trading Education',
    num: '23 Course',
    bg: '#fcf1eb',
  },
                ...
                <div className="row">
                  <div className="col-lg-12 mb-3">
                    <div
                      ...
                      style={{
                        backgroundImage: `url("https://res.cloudinary.com/glocomxus/image/upload/v1655089834/1100xxs_1_fcfe9df648.webp?97118.29999999702")`,
                      }}
                    >
