...
const AdminTopnav = ({ userLoginState, logout, dispatch }) => {
  const handleLogout = () => {
    ...
    <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow-xs ">
      ...
      <ul className="navbar-nav">
        ...
        <li className="nav-item dropdown no-arrow">
          ...
          >
            <img
              src={`${process.env.REACT_APP_API_BASE_URL}/${userLoginState.profilePic}`}
              alt="user"
            ...
            <i
              ...
              className="ms-3 feather-log-out d-none d-lg-block"
            ></i>
            {/* </div> */}
          </a>
